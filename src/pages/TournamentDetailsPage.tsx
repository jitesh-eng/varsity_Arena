            ...
            <div className="bg-gray-700 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div className="text-center">
                  ...
                  <p className="font-semibold text-white">gaming@paytm</p>
                </div>
                <div className="text-center">
                  <p className="text-sm text-gray-400">Account Holder</p>
                  <p className="font-semibold text-white">Free Fire Arena</p>
                </div>
                <div className="text-center">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <div className="bg-white p-3 rounded-lg">
                  <QRCode
                    value={`upi://pay?pa=gaming@paytm&pn=Free Fire Arena&am=${tournament.entry_fee}&cu=INR`}
                    size={128}
                  />
                </div>
              </div>
